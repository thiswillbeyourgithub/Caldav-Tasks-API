...
| Update Task             | ❌                                        | Partial (Not directly tested as a dedicated API method) | No direct `update_task()` method. Requires manual `caldav.Todo` modification and `save()`. Advanced. |
